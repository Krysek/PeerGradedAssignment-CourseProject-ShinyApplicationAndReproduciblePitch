...
* The developed shiny app for this assignment is avalilable in this presentation and at: https://frei.shinyapps.io/ShinyApplication/

<br /><br />

* The source codes of ui.R and server.R and also the presentation are available on the GitHub repo: 
https://github.com/Krysek/PeerGradedAssignment-CourseProject-ShinyApplicationAndReproduciblePitch.git
...
```{r}
knitr::include_app("https://frei.shinyapps.io/ShinyApplication/", height = "450px")
```
The developed shiny app for this assignment is also avalilable at: https://frei.shinyapps.io/ShinyApplication/
